 ...
 *      @c ght_crc_hash()
 */
typedef ght_uint (*ght_fn_hash_t)(ght_hash_key_t *p_key);
 ...
 */
ght_uint ght_one_at_a_time_hash(ght_hash_key_t *p_key);
 ...
 */
ght_uint ght_rotating_hash(ght_hash_key_t *p_key);
 ...
 */
ght_uint ght_crc_hash(ght_hash_key_t *p_key);
